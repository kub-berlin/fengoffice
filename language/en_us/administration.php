<?php
  ...
  return array(
    ...
    'user config option desc can notify from quick add' => 'This option enables notifying assigned user, after a task has been added or updated',  
  ...
  // END HIDDEN
	...
	'select member type' => 'Select type',
        ...
        'file extension no allow classify' => 'You can not classify attachment \'{0}\'. Your Administrator does not allow this file extension.',
  		...
  		'dimension options desc' => 'Here you can define and change the dimension options to suit your needs.',
  		'enable or disable dimension types' => 'Enable or disable dimension types',
  		'enable or disable dimension types desc' => 'In this section you can choose which type of dimension members will be used.',
  		'success edit dimension options' => 'Dimension options modified succesfully.',
  		'dimension names' => 'Dimension names',
  		'dimension names desc' => 'In this section you can change the names of the dimensions, leave blank the \'Custom name\' input to use the default name.',
