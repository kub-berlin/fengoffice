<?php return array(
	...
	'user config option name show dashboard info widget' => 'Mostrar widget de información del espacio',
	'user config option name my tasks is default view' => 'La vista por defecto muestra sólo las tareas asignadas a mi',
	'user config option desc my tasks is default view' => 'Si se selecciona no, se mostrarán todas las tareas del área de trabajo y sus subáreas',
	...
	'user config option desc can notify from quick add' => 'Al crear o editar una tarea, si tiene esta opción habilitada, por defecto se le avisará al usuario asignado acerca de la creación de la tarea o modificación de la misma',
	...
	'user config option desc detect_mime_type_from_extension' => 'Si se habilita, el tipo mime de los archivos es generado a partir de la extensión del archivo.',
	...
	'user config option desc always show unread mail in dashboard' => 'Al seleccionar NO sólo se mostraran los correos del área de trabajo activa',
	'workspace emails' => 'Correos del área de trabajo',
	'user config option name tasksShowWorkspaces' => 'Mostrar áreas de trabajo',
	...
	'user config option name initialWorkspace' => 'Área de trabajo inicial',
	'user config option desc initialWorkspace' => 'Esta opción le permite escoger cuál será el área de trabajo seleccionado cuando inicia, o puede escoger recordar la última área de trabajo visto.',
	...
	'user config option name noOfTasks' => 'Número de tareas mostradas por defecto',
	...
	'user config option name attach_docs_content' => 'Adjuntar el contenido de archivos',
	'user config option desc attach_docs_content' => 'Cuando esta opcioón está habilitada, los archivos van a ser adjuntados de manera usual. Sino se adjunta un link al archivo.',
	...
	'user config option name create_contacts_from_email_recipients' => 'Crear contactos de destinatarios de correo',
	'user config option desc create_contacts_from_email_recipients' => 'Si esta opción está en "Sí" se creará automáticamente un contacto por cada dirección a la que envía un correo. Necesita el permiso "Puede modificar todos los contactos".',
	'user config option name drag_drop_prompt' => 'Acción a tomar al arrastrar a un área de trabajo',
	'user config option desc drag_drop_prompt' => 'Escoja qué acción tomar al arrastrar un objeto a un área de trabajo.',
	...
	'user config option desc mail_drag_drop_prompt' => 'Escoja qué hacer con los adjuntos de un correo al arrastrarlo a un área de trabajo.',
	...
	'user config option desc search_engine' => 'Escoja qué motor de búsquedas usar. "Completa" hará una búsqueda más exhaustiva pero tomará más tiempo que "Rápida". "Completa" no se recomienda para instalaciones muy cargadas.',
	...
	'user config option name show_file_revisions_search' => 'Ver contenidos de los documentos al realizar búsquedas',
...
{0}',
	...
	'can_manage_dimension_members description' => 'Si este permiso está marcado el usuario tendrá permisos completos sobre los miembros de dimensiones. Podrá crear, editar y eliminar miembros. En la práctica, los miembros pueden ser espacios de trabajo, clientes, proyectos, etc. Si el usuario no maneja configuraciones de seguridad (permisos) entonces al crear un nuevo cliente/proyecto/espacio deberá seleccionar obligatoriamente la ubicación del mismo para que los permisos puedan ser heredados.',
	...
	'user config option desc report_time_colums_display' => 'Si se selcciona el formato usual se mostrarán las fechas de forma descriptiva (ej.: 2 horas, 15 minutos), de lo contrario se mostrará la cantidad de minutos o segundos.',
		...
		'income general config description' => 'Aquí se especifican las opciones de configuración generales para las facturas.',
		'invoice copies' => 'Vías',
		'copies config description' => 'Agregar, editar y borrar vías de facturas.',
		'invoice types' => 'Tipos de facturas',
		'invoice types config description' => 'En esta sección se especifican los tipos de facturas que su organización puede emitir.',
		'invoice notebooks' => 'Libretas',
		'invoice notebooks config description' => 'En esta sección se pueden configurar los datos de las libretas de facturas utlizadas en su organización.',
		'taxes' => 'Impuestos',
		'taxes config description' => 'En esta sección se configuran los impuestos a incluír en las facturas.',
		'invoice logo' => 'Logo de la factura',
		'invoice logo config description' => 'Editar el logo a incluír en las facturas.',
		
		'object custom properties' => 'Propiedades personalizadas de objetos',
		'custom properties for' => 'Propiedades personalizadas para {0}',
		'default value' => 'Valor inicial',
		'list values comma separated' => 'Valores de lista (separados por coma)',
		'cp list values hint' => 'Solo para listas.',
